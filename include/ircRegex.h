...
# define	R_MIDDLE_PARAM		R_START_STRING R_SPACE R_0_OR_1(R_CAPTURE(R_MIDDLE))
...
# define	R_CAPTURE_TARGET_NAME R_CAPTURE(R_ALTERNATION(R_CHANNEL_NAME, R_CHAR_INV_GROUP(NICKNAME_START)R_X_TO_Y(R_CHAR_INV_GROUP(NICKNAME_CHAR),0,16)))
