...
#define ERR_MSG_NORECIPIENT			"No recipient given (<PRIVMSG>)"
#define ERR_NORECIPIENT(...)		build(ERR_CODE_NORECIPIENT, ##__VA_ARGS__, ERR_MSG_NORECIPIENT, NULL)
...
#define ERR_MSG_UNKNOWNCOMMAND		"Unknown command"
#define ERR_UNKNOWNCOMMAND(...)		build(ERR_CODE_UNKNOWNCOMMAND, ##__VA_ARGS__, ERR_MSG_UNKNOWNCOMMAND, NULL)
